                ...
                <div class="pw_content">
                    <div class="pw_header">
                        ...
                        <ul class="list-unstyled team-info margin-0 p-t-15">
                            <li class="m-r-15"><small>Lječnički tim</small></li>
                    ...
                    <div class="pw_meta">
                        ...
                        <a href="{{route('departments.more-departments')}}" class="btn btn-primary btn-simple btn-round">više...</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card project_widget">
                ...
                <div class="pw_content">
                    ...
                    <div class="pw_meta">
                        ...
                        <button class="btn btn-primary btn-simple btn-round">više...</button>
                    </div>
                </div>
            </div>
        </div>

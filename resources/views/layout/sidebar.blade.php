            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="{{ Request::segment(1) === 'doctor' ? 'active open' : null }}">
                        <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account-add"></i><span>Lječnici</span></a>
                        <ul class="ml-menu">
                            <li class="{{ Request::segment(2) === 'doctors' ? 'active' : null }}"><a href="{{route('doctor.doctors')}}">Svi lječnici</a></li>
                            <li class="{{ Request::segment(2) === 'add-doctor' ? 'active' : null }}"><a href="{{route('doctor.add-doctor')}}">Novi lječnik</a></li>
                            {{--<li class="{{ Request::segment(2) === 'profile' ? 'active' : null }}"><a href="{{route('doctor.profile')}}">Profil lječnika</a></li>
                            <li class="{{ Request::segment(2) === 'events' ? 'active' : null }}"><a href="{{route('doctor.events')}}">Raspored lječnika</a></li>--}}
                        </ul>
                    </li>
                    <li class="{{ Request::segment(1) === 'patients' ? 'active open' : null }}">
                        ...
                        <ul class="ml-menu">
                            ...
                            {{--<li class="{{ Request::segment(2) === 'patients-profile' ? 'active' : null }}"><a href="{{route('patients.patients-profile')}}">Profil pacijenta</a></li>--}}
                   ...
                   {{-- <li class="header">Dodatno</li>--}}
                    <li class="{{ Request::segment(1) === 'blog' ? 'active open' : null }}">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li class="{{ Request::segment(2) === 'new-post' ? 'active' : null }}"><a href="{{route('blog.new-post')}}">Napiši blog </a></li>
                    ...
                    <li class="{{ Request::segment(1) === 'file-manager' ? 'active open' : null }}">
                        ...
                        <ul class="ml-menu">
                            {{--<li class="{{ Request::segment(2) === 'dashboard' ? 'active' : null }}"><a href="{{route('file-manager.dashboard')}}">Svi file-ovi</a></li>--}}

...
<div class="row clearfix">
    ...
    <div class="col-lg-4 col-md-12">
        <div class="card member-card">
            ...
            <div class="member-img">
                <a href="{{route('doctor.profile')}}" class=""><img src="../assets/images/lg/avatar2.jpg" class="rounded-circle" alt="profile-image"></a>
            </div>
            <div class="body">
                <div class="col-12">
    ...
    <div class="col-lg-4 col-md-12">
        <div class="card member-card">
            ...
            <div class="member-img">
                <a href="{{route('doctor.profile')}}" class=""><img src="../assets/images/lg/avatar1.jpg" class="rounded-circle" alt="profile-image"></a>
            </div>
            <div class="body">
                <div class="col-12">
                    <ul class="social-links list-unstyled">
